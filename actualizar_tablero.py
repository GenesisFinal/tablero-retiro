...
def compute_official_tables(series):
    ...
    periods_def = [
        ...
        ("Ejercicio 2025/2026 (Cerrado)", date_to_idx.get('2025-07', 25), date_to_idx.get('2026-06', 36)),
        ("Ejercicio 2024/2025 (Cerrado)", date_to_idx.get('2024-07', 13), date_to_idx.get('2025-06', 24)),
        ("Ejercicio 2023/2024 (Cerrado)", date_to_idx.get('2023-07', 1), date_to_idx.get('2024-06', 12)),
        ("Ejercicio 2026/2027 (En curso)", date_to_idx.get('2026-07', 37), last_idx),
